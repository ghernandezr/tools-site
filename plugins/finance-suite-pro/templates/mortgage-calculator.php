		...
		<aside class="fsp-sidebar" aria-label="Mortgage parameters">
			...
			<div class="fsp-glass-card">
				...
				<div class="fsp-field-stack">
					...
					<!-- Down payment error — shown when down >= home price -->
					<div class="fsp-down-error" id="fspm-down-error" style="display:none;">
						...
						<span>Down payment cannot equal or exceed home price</span>
					</div>
