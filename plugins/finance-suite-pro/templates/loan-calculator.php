...
<div class="fsp-calculator fsp-loan-calculator" id="fsp-loan-calculator" role="main">
	...
	<header class="fsp-calc-header">
		<div class="fsp-header-brand">
			...
			<div>
				<h2 class="fsp-calc-title">Loan Payment <span class="fsp-title-accent">Calculator</span></h2>
				<p class="fsp-calc-subtitle">Advanced Financial Strategy Tool</p>
			</div>
		</div>
	</header>
	...
	<div class="fsp-layout">
		...
		<!-- ── LEFT: Parameters ─────────────────────────── -->
		<aside class="fsp-sidebar" aria-label="Loan parameters">

			<div class="fsp-glass-card">
				<h3 class="fsp-section-label">Core Parameters</h3>
				<div class="fsp-field-stack">

					<div class="fsp-input-group">
						<label class="fsp-label-tech" for="fsp-amount">Loan Amount ($)</label>
						<input
							type="number"
							id="fsp-amount"
							class="fsp-input-field"
							name="fsp_amount"
							min="1" max="99999999" step="100"
							placeholder="450000"
					...
					<div class="fsp-field-row">
						<div class="fsp-input-group">
							<label class="fsp-label-tech" for="fsp-rate">Rate (%)</label>
							<input
								type="number"
								id="fsp-rate"
								class="fsp-input-field"
						...
						<div class="fsp-input-group">
							<label class="fsp-label-tech" for="fsp-years">Term (Years)</label>
							<input
								type="number"
								id="fsp-years"
								class="fsp-input-field"
					...
					<div class="fsp-input-group fsp-input-group--accent">
						<label class="fsp-label-tech fsp-label-tech--accent" for="fsp-extra">Monthly Extra Payment</label>
			...
			<div class="fsp-glass-card">
				...
				<div class="fsp-field-row">
					<div class="fsp-input-group">
						<label class="fsp-label-tech" for="fsp-tax">Property Tax/Yr</label>
						<input
							type="number"
							id="fsp-tax"
							class="fsp-input-field"
					...
					<div class="fsp-input-group">
						<label class="fsp-label-tech" for="fsp-insurance">Insurance/Yr</label>
						<input
							type="number"
							id="fsp-insurance"
							class="fsp-input-field"
		...
		<div class="fsp-cross-tool">
			<svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
			<?php if ( ! empty( $defaults['mortgage_url'] ) ) : ?>
				<a href="<?php echo esc_url( $defaults['mortgage_url'] ); ?>">Buying a home? Use the Mortgage Calculator &rarr;</a>
			<?php else : ?>
				<span>Buying a home? Try the <strong>Mortgage Calculator</strong> for PITI &amp; PMI.</span>
			<?php endif; ?>
		</div>
		...
		<!-- ── RIGHT: Results Panel ──────────────────────── -->
		<main class="fsp-panel" id="fsp-results" aria-label="Calculation results">

			<!-- KPI Cards -->
			<div class="fsp-kpi-row">
				<div class="fsp-kpi-card fsp-kpi-card--primary">
					<span class="fsp-kpi-label">Real Monthly (PITI)</span>
					<strong class="fsp-kpi-value" id="fsp-monthly-payment">$0</strong>
					<span class="fsp-kpi-note">Includes Extra + Escrow</span>
				</div>
				<div class="fsp-kpi-card fsp-kpi-card--green">
					<span class="fsp-kpi-label">Interest Avoided</span>
					<strong class="fsp-kpi-value fsp-kpi-value--green" id="fsp-interest-saved">$0</strong>
				...
				<div class="fsp-kpi-card fsp-kpi-card--blue">
					...
					<strong class="fsp-kpi-value" id="fsp-payoff-time">0Y 0M</strong>
					<span class="fsp-kpi-note fsp-kpi-note--blue" id="fsp-time-saved">Time reduction</span>
				</div>
			</div>
			...
			<div class="fsp-impact-panel" aria-label="Financial impact summary">
				<div class="fsp-impact-bg-icon" aria-hidden="true">
					<svg xmlns="http://www.w3.org/2000/svg" width="120" height="120" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg>
				</div>
				<div class="fsp-impact-content">
					<div class="fsp-impact-left">
						...
						<p class="fsp-impact-desc">Every dollar extra reduces your principal directly, causing a massive interest snowball effect.</p>
					</div>
					<div class="fsp-impact-stats">
						<div class="fsp-impact-stat">
							<p class="fsp-impact-stat-label">Total Interest</p>
							<p class="fsp-impact-stat-value" id="fsp-total-interest">$0</p>
						...
						<div class="fsp-impact-stat fsp-impact-stat--green">
							...
							<p class="fsp-impact-stat-value fsp-impact-stat-value--green" id="fsp-total-savings">$0</p>
			...
			<div class="fsp-tabs-card">
				<div class="fsp-tabs-nav" role="tablist" aria-label="Analysis tabs">
					<button type="button" class="fsp-tab-btn fsp-tab-btn--active" id="fsp-btn-breakdown" role="tab" aria-selected="true"  aria-controls="fsp-tab-breakdown"   onclick="FSP_LC.switchTab('breakdown')">Payment Breakdown</button>
					<button type="button" class="fsp-tab-btn"                     id="fsp-btn-equity"    role="tab" aria-selected="false" aria-controls="fsp-tab-equity"      onclick="FSP_LC.switchTab('equity')">Equity Growth</button>
					<button type="button" class="fsp-tab-btn"                     id="fsp-btn-amort"     role="tab" aria-selected="false" aria-controls="fsp-tab-amort"       onclick="FSP_LC.switchTab('amort')">Amortization Table</button>
					<button type="button" class="fsp-tab-btn"                     id="fsp-btn-refi"      role="tab" aria-selected="false" aria-controls="fsp-tab-refi"        onclick="FSP_LC.switchTab('refi')">Refi Alerts</button>
				</div>

				<div class="fsp-tabs-body">

					<!-- Tab 1: Payment Breakdown -->
					<div id="fsp-tab-breakdown" class="fsp-tab-panel" role="tabpanel" aria-labelledby="fsp-btn-breakdown">
						<div class="fsp-breakdown-wrap">
							<div class="fsp-donut-wrap" aria-hidden="true">
								<svg viewBox="0 0 100 100" class="fsp-donut-svg">
									...
									<circle id="fsp-circle-pi"     cx="50" cy="50" r="40" fill="none" stroke="#6366f1" stroke-width="12" stroke-dasharray="251.2" stroke-dashoffset="100"/>
									<circle id="fsp-circle-escrow" cx="50" cy="50" r="40" fill="none" stroke="#94a3b8" stroke-width="12" stroke-dasharray="251.2" stroke-dashoffset="200"/>
								</svg>
								<div class="fsp-donut-center">
									<span id="fsp-pct-pi" class="fsp-donut-pct">0%</span>
					...
					<!-- Tab 2: Equity Growth -->
					<div id="fsp-tab-equity" class="fsp-tab-panel fsp-tab-panel--hidden" role="tabpanel" aria-labelledby="fsp-btn-equity">
						<div class="fsp-equity-grid">
							<div class="fsp-equity-card">
								<span class="fsp-equity-label" id="fsp-eq-label">Equity at 10 Years</span>
								<strong class="fsp-equity-value" id="fsp-eq-value">$0</strong>
								<p class="fsp-equity-note" id="fsp-eq-pct">0% of total loan paid</p>
							</div>
							<div class="fsp-equity-card">
								<span class="fsp-equity-label">Total Time Saved</span>
								<strong class="fsp-equity-value" id="fsp-eq-time">0 months</strong>
					...
					<div id="fsp-tab-amort" class="fsp-tab-panel fsp-tab-panel--hidden" role="tabpanel" aria-labelledby="fsp-btn-amort">
						<div class="fsp-amort-controls">
							<div class="fsp-view-toggle" role="group" aria-label="Schedule view">
								<button type="button" id="fsp-view-annual"  class="fsp-view-btn fsp-view-btn--active" onclick="FSP_LC.setScheduleView('annual')">Annual</button>
								<button type="button" id="fsp-view-monthly" class="fsp-view-btn"                     onclick="FSP_LC.setScheduleView('monthly')">Monthly</button>
							</div>
						</div>
						<div class="fsp-table-scroll fsp-table-scroll--limited">
							<table class="fsp-table" id="fsp-amort-table" aria-label="Amortization schedule">
								<thead>
									<tr>
					...
					<!-- Tab 4: Refi Alerts -->
					<div id="fsp-tab-refi" class="fsp-tab-panel fsp-tab-panel--hidden" role="tabpanel" aria-labelledby="fsp-btn-refi">
						<div class="fsp-refi-wrap">
							...
							<p class="fsp-refi-intro">
								Analyzing current loan at <strong id="fsp-refi-current-rate">0%</strong>.
							...
							<div class="fsp-refi-card">
								<div class="fsp-refi-card-row">
									...
									<span class="fsp-refi-card-rate" id="fsp-refi-target-rate">0%</span>
								</div>
								<div class="fsp-refi-card-row fsp-refi-card-row--bottom">
									<div>
										<p class="fsp-refi-savings-label">Estimated Monthly Savings</p>
										<p class="fsp-refi-savings-value" id="fsp-refi-savings">$0</p>
									</div>
								</div>
							</div>
